...
Route::group(['middleware' => ['adminlocalize', 'demo']], function () {
    Route::prefix('admin')->group(function () { 
        ...
        Route::group(['middleware' => 'permissions:Manage Orders'], function () {
            ...
            Route::get('/order/curier/status/{id}/{field}/{value}', 'Back\OrderController@curierStatus')->name('back.order.curier.status');
        });
 ...
 //------------ Curier SETTING ------------
            Route::get('/setting/curier', 'Back\CurierSettingController@curier')->name('back.setting.curier');
            Route::post('/setting/curier/update', 'Back\CurierSettingController@update')->name('back.setting.curier.update');
        });
